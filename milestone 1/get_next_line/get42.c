...
/*   Updated: 2025/08/18 02:27:16 by olacerda         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "get_next_line.h"

void    liner(char **line, t_gnl *x, int *endtotal)
{
    char        *newline;
    int         index;
    ...
    if (!newline)
    	return ;
    index = -1;
    while (++index < (*endtotal - x->end) && *line) // Copia linhas anteriores
