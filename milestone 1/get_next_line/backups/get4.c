...
/*   Updated: 2025/06/17 02:15:27 by olacerda         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "get_next_line.h"

void liner(char **line, char *buffed, int *buff, int readcount, int *endcount)
{
    char        *newline;
    int         index;
    ...
    while (buff[START] <= (buff[END]) && buff[START] < BUFFER_SIZE)
...
char *get_next_line(int fd)
{
    ...
    while (buffed[buff[END]] != '\n' && readcount > 0)
    {
		...
		liner(&line, buffed, buff, readcount, &endcount);
    }
